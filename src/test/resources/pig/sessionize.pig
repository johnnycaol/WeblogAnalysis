...
DEFINE Sessionize datafu.pig.sessions.Sessionize('15m');--an idle period of 15 minutes indicates that a new session has started
...
STORE sessionized_logs INTO 'sessionized_logs.out';
