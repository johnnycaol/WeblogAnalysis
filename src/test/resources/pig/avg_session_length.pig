...
-- Calculate average session length -> 100.28 seconds
avg_session_length = FOREACH (GROUP session_length ALL) {
 GENERATE ROUND_TO(AVG(session_length.session_length), 2) AS avg_session_length;
};

STORE avg_session_length INTO 'avg_session_length.out';
